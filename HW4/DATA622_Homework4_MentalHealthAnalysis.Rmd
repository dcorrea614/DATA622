...
The linear SVM model outperformed the radial SVM model, however the Stochastic Gradient Boosting model holds the best accuracy on the test data.  This looks to be the results of having a higher specificity performance in the model.  This outcome may be the results of Gradient Boosting having low bias and variance with its boosting method.  
